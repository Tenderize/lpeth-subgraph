...
export const QUOTER = Address.fromString(
  "0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6"
);
export const WETH9_ARBITRUM = Address.fromString(
  "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1"
);
export const USDC_ARBITRUM = Address.fromString(
  "0xaf88d065e77c8cC2239327C5EDb3A432268e5831"
);
export const USDC_MAINNET = Address.fromString(
  "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"
);
export const WETH_MAINNET = Address.fromString(
...
export const decodeTokenId = (tokenId: BigInt): DecodedTokenId => {
  ...
  let uint96 = BigInt.fromUnsignedBytes(
    Bytes.fromHexString(hexId.substring(20, 32))
  );
...
export function findClosestRebaseEvent(
  ...
  for (let i = receipt.logs.length - 1; i >= 0; i--) {
    ...
    if (log.topics.length == 0 || log.topics[0].toHexString() != REBASE_TOPIC)
      continue;
